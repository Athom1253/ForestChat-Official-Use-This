...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (settings?.custom_theme_color) {
      document.documentElement.style.setProperty('--color-primary', settings.custom_theme_color)
    } else {
  ...
  }, [settings?.theme, settings?.reduced_motion, settings?.custom_theme_color])
