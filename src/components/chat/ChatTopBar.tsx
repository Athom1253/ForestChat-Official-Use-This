...
export function ChatTopBar({ channel, onSearch, onMembers, onPinned, onSettings, onCall, onSync }: ChatTopBarProps) {
  ...
  return (
    <div className="h-14 flex items-center justify-between px-4 border-b border-border bg-surface flex-shrink-0">
      ...
      <div className="flex items-center gap-1">
        ...
        <button onClick={onSync} className="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-surface-hover text-text-muted hover:text-text transition-colors" title="Sync / Refresh">
